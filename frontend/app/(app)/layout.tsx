      ...
      <aside className="w-[240px] bg-[#0f172a] border-r border-white/5 flex flex-col justify-between shrink-0">
        <div>
          ...
          <div className="flex items-center gap-3 px-6 py-6 border-b border-white/5">
            <div className="w-6 h-6 bg-gradient-to-br from-[#6366f1] to-[#8b5cf6] rounded-md shadow-[0_0_10px_rgba(99,102,241,0.5)]"></div>
            <span className="font-semibold text-lg tracking-tight font-display text-white">
              LeadFlow <span className="text-[10px] bg-[#10b981]/15 text-[#10b981] border border-[#10b981]/30 px-1 py-0.5 rounded font-bold ml-1">AI</span>
            </span>
          </div>
